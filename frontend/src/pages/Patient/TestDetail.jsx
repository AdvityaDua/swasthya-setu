...
const TestDetail = () => {
  ...
  const reportDownloadUrl =
    report && report.available ? `${import.meta.env.VITE_API_ORIGIN}${report.download_path}` : null;
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="max-w-ful flex justify-center">
        {testDetail.ai_result && (
            ...
            <CardContent className="grid gap-4">
              ...
              {testDetail.ai_result.heatmap_url && (
                <div>
                  ...
                  <img
                    src={import.meta.env.VITE_API_ORIGIN + testDetail.ai_result.heatmap_url}
                    alt="AI heatmap"
              ...
              {reportDownloadUrl && (
                <div className="pt-4 border-t">
                  <p className="text-sm font-medium">Download Report In</p>
                  <div className="pt-2">
                    <ReportManager
                      testId={test_id}
                      initialLanguage={"en"}
