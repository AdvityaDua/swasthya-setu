...
To see the demo video, kindly open the following link: https://drive.google.com/drive/folders/1WebXfmmmn6YEvm6yXNRkYZqH_WQyKCgq 
...
- **Doctor-in-the-loop**: AI suggestions are always validated by medical professionals  
- **Ethical AI**: No autonomous diagnosis or treatment decisions  
- **Context-aware insights**: AI operates on structured patient history, not isolated symptoms  
- **Accessibility-first**: Multilingual support and simple UX  
- **Interoperability**: Designed to integrate with existing diagnostic and hospital workflows  
...
### AI-Assisted Triage
- Symptom intake with structured questioning
- Risk categorization (low / medium / high)
- Diagnostic escalation suggestions
- No direct diagnosis or prescriptions

### Practitioner & Doctor Workflow
...
- Regional language support for reports and UI
- AI-assisted translation where applicable
...
- Backend and frontend under active development
- AI pipelines under iterative validation
...
- All medical decisions require human validation
- Silent failures (e.g., missing audio, missing data) must be explicitly surfaced
- Precision-sensitive fields (e.g., geolocation, vitals) are validated at boundaries
